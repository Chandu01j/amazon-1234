...
public class TeatTodayDealAddtoCart {
...
public static void main(String[] args) throws InterruptedException {
		...
		homePageAmazon.clickonTodayDeal();
		homePageAmazon.clickonselectcategary();
		homePageAmazon.clickonselectpro();
		homePageAmazon.clickonSelectprotoday();
